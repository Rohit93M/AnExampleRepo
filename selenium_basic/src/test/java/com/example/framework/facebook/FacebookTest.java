...
public class FacebookTest extends BaseClass {
	...
	@Test(priority = 1, groups = { "smoke","functional" }, dataProvider = "fbLoginData01", dataProviderClass = TestDataProvider.class)
	public void writeAScriptToEnterDataAndLoginIntoFacebookLoginPage(String url, String title, String username, String password) {
